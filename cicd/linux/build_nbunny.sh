...
CPPFLAGS="-I $(pwd)/../../installdir/include/luajit-2.1 -I $(pwd)/../../love2d-${LOVE_BRANCH}/src -I $(pwd)/../../love2d-${LOVE_BRANCH}/src/modules" LDFLAGS="-L$(pwd)/../../installdir/lib -llove -lluajit-5.1 -lsentry" make config=release nbunny
cd ../..
