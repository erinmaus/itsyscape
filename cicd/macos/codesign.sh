...
/usr/bin/codesign --timestamp --force -s "$MACOS_CERTIFICATE_NAME" --options runtime $1 --entitlements ./cicd/macos/build/love2d/platform/xcode/love-macosxRelease.entitlements -v
