--------------------------------------------------------------------------------
-- Resources/Game/DB/Sailing/Ships/Yendorian.lua
--
...
local Ship = ItsyScape.Resource.SailingShip "NPC_Yendorian"

local PRIMARY_COLOR = ItsyScape.Utility.Color.fromHexString("9c7eab")
local METAL_COLOR   = ItsyScape.Utility.Color.fromHexString("e0c45b")
local WOOD_COLOR    = ItsyScape.Utility.Color.fromHexString("9c7eab")
local GLASS_COLOR   = ItsyScape.Utility.Color.fromHexString("d5f6ff")
local SAIL_COLOR    = ItsyScape.Utility.Color.fromHexString("9c7eab")
