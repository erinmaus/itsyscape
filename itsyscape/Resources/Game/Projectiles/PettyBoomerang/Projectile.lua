--------------------------------------------------------------------------------
-- ItsyScape/Resources/Game/Projectiles/PettyBoomerang/Projectile.lua
--
...
function PettyBoomerang:getTextureFilename()
	return "Resources/Game/Projectiles/PettyBoomerang/Texture.png"
end
