--------------------------------------------------------------------------------
-- ItsyScape/Resources/Game/Projectiles/TheEmptyKing_FullyRealized_Staff/Projectile.lua
--
...
Staff.INNER_RADIUS = 1.5
Staff.OUTER_RADIUS = 6.0
...
function Staff:update(elapsed)
	...
	for _, beam in ipairs(self.beams) do
		beam:getMaterial():setColor(Color(Staff.COLOR.r, Staff.COLOR.g, Staff.COLOR.b, alpha))
	end
end
