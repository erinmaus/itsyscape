...
function Fisherman:ready(director, game)
	...
	self:applySkin(
		...
		"PlayerKit2/Hair/ForwardSwirl.lua",
	...
	self:applySkin(
		...
		{ Player.Palette.PRIMARY_GREEN, Player.Palette.PRIMARY_BROWN,  Player.Palette.PRIMARY_GREY, Player.Palette.PRIMARY_BLACK, Player.Palette.PRIMARY_GREY })
	self:applySkin(
