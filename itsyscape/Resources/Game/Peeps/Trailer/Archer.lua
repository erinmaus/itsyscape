--------------------------------------------------------------------------------
-- Resources/Peeps/Trailer/Archer.lua
--
...
local Archer = Class(Player)

function Archer:new(resource, name, ...)
	Player.new(self, resource, name or 'Archer', ...)
...
function Archer:ready(director, game)
