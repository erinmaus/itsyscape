--------------------------------------------------------------------------------
-- Resources/Game/Peeps/ViziersRock/Bartender.lua
--
...
local Bartender = Class(Player)

function Bartender:new(resource, name, ...)
	Player.new(self, resource, name or 'Bartender', ...)
end

function Bartender:ready(director, game)
	...
	self:applySkin(
		...
		{ Player.Palette.PRIMARY_BLUE:setHSL(nil, 0.3, nil), Player.Palette.PRIMARY_BROWN,  Player.Palette.PRIMARY_GREY, Player.Palette.PRIMARY_BLACK, Player.Palette.PRIMARY_GREY })
	self:applySkin(
