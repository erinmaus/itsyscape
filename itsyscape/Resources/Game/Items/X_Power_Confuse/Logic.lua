--------------------------------------------------------------------------------
-- Resources/Game/Items/X_Power_Confuse/Logic.lua
--
...
local Confuse = Class(ProxyXWeapon)

function Confuse:perform(peep, target)
...
function Confuse:getProjectile()
	return "Power_Confuse"
end
