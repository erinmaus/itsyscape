{
	...
	texture = "Resources/Game/Water/BloodyBrain1/Texture.png",
	uniforms = {
		...
		scape_FoamColor = { "color", "aa7399", 1.0 },
		scape_DiffuseColor = { "color", "aa7399", 0.25 },
		scape_ShallowWaterColor = { "color", "a02c4b", 0.75 },
		scape_DeepWaterColor = { "color", "7a253c", 1.0 },

		scape_FoamTexture = { "texture", "Resources/Game/Water/BloodyBrain1/Foam.png" },
	},
