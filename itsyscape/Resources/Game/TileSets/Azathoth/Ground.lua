--------------------------------------------------------------------------------
-- Resources/Game/TileSets/Azathoth/Ground.lua
--
...
local AzathothGround = Class(GroundDecorations)

function AzathothGround:new()
	GroundDecorations.new(self, "Azathoth")
	...
	self:registerTile("checkered", BrickBlock:Bind(self) {
