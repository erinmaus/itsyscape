--------------------------------------------------------------------------------
-- Resources/Game/Props/WallLamp_ViziersRock/View.lua
--
...
Lamp.MIN_ATTENUATION = 4
Lamp.MAX_ATTENUATION = 6
Lamp.MIN_COLOR_BRIGHTNESS = 0.9
Lamp.MAX_COLOR_BRIGHTNESS = 1.0
Lamp.LIGHT_OFFSET = Vector.UNIT_Y * 1.5
...
function Lamp:load()
	...
	resources:queue(
		TextureResource,
		"Resources/Game/Props/WallLamp_ViziersRock/Texture.png",
		function(texture)
			self.texture = texture
		end)
	resources:queue(
		StaticMeshResource,
		"Resources/Game/Props/WallLamp_ViziersRock/Model.lstatic",
		function(mesh)
			self.mesh = mesh
			self.node:fromGroup(mesh:getResource(), "WallLamp")
