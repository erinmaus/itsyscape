--------------------------------------------------------------------------------
-- Resources/Game/Props/Clutter_Cooking_StockPot/View.lua
--
...
local StockPot = Class(SimpleStaticView)

StockPot.DESCRIPTION = {
	{
		mesh = "Resources/Game/Props/Clutter_Cooking_StockPot/Model.lstatic",
		group = "stock-pot.metal",

		material = {
			shader = "Resources/Shaders/SpecularTriplanar",
			texture = "Resources/Game/Props/Clutter_Cooking_StockPot/Metal.png",
