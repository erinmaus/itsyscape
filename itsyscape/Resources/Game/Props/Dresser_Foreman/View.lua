--------------------------------------------------------------------------------
-- Resources/Game/Props/Dresser_Foreman/View.lua
--
...
local Dresser = Class(SimpleStaticView)

Dresser.DESCRIPTION = {
	{
		mesh = "Resources/Game/Props/Dresser_Foreman/Model.lstatic",
		group = "grain",

		material = {
			shader = "Resources/Shaders/SpecularTriplanar",
			texture = "Resources/Game/Props/Dresser_Foreman/Grain.png",
