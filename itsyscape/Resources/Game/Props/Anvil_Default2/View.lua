...
function AnvilView:load()
	...
	resources:queueEvent(function()
		...
		anvilMaterial:setOutlineThreshold(0.5)
		anvilMaterial:send(anvilMaterial.UNIFORM_FLOAT, "scape_TriplanarScale", 0)
		anvilMaterial:send(anvilMaterial.UNIFORM_FLOAT, "scape_SpecularWeight", 0.5)
