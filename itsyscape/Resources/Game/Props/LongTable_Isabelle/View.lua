--------------------------------------------------------------------------------
-- Resources/Game/Props/LongTable_Isabelle/View.lua
--
...
Table.DESCRIPTION = {
	{
		mesh = "Resources/Game/Props/LongTable_Isabelle/Model.lstatic",
		group = "grain",

		material = {
			shader = "Resources/Shaders/SpecularTriplanar",
			texture = "Resources/Game/Props/LongTable_Isabelle/Grain.png",
