--------------------------------------------------------------------------------
-- Resources/Game/Props/Counter_Foreman/View.lua
--
...
Counter.DESCRIPTION = {
	{
		mesh = "Resources/Game/Props/Counter_Foreman/Model.lstatic",
		group = "grain",

		material = {
			shader = "Resources/Shaders/SpecularTriplanar",
			texture = "Resources/Game/Props/Counter_Foreman/Grain.png",
