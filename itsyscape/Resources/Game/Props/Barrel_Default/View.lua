--------------------------------------------------------------------------------
-- Resources/Game/Props/Barrel_Default/View.lua
--
...
function Crate:getTextureFilename()
	return "Resources/Game/Props/Barrel_Default/Texture.png"
end

function Crate:getModelFilename()
	return "Resources/Game/Props/Barrel_Default/Model.lstatic", "Barrel"
end
