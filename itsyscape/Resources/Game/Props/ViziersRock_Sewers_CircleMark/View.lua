--------------------------------------------------------------------------------
-- Resources/Game/Props/ViziersRock_Sewers_CircleMark/View.lua
--
...
local CircleMark = Class(PropView)

function CircleMark:load()
	PropView.load(self)
	...
	resources:queue(
		TextureResource,
		"Resources/Game/Props/ViziersRock_Sewers_CircleMark/Texture.png",
		function(texture)
