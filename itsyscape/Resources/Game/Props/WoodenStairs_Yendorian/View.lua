--------------------------------------------------------------------------------
-- Resources/Game/Props/WoodenStairs_Yendorian/View.lua
--
...
function WoodenStairs:load()
	...
	resources:queue(
		TextureResource,
		"Resources/Game/Props/WoodenStairs_Yendorian/Texture.png",
		function(texture)
			self.texture = texture
		end)
	resources:queue(
		StaticMeshResource,
		"Resources/Game/Props/WoodenStairs_Yendorian/Model.lstatic",
		function(mesh)
			self.mesh = mesh
