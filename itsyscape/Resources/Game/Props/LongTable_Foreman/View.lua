--------------------------------------------------------------------------------
-- Resources/Game/Props/LongTable_Foreman/View.lua
--
...
local LongTable = Class(SimpleStaticView)

LongTable.DESCRIPTION = {
	{
		mesh = "Resources/Game/Props/LongTable_Foreman/Model.lstatic",
		group = "grain",

		material = {
			shader = "Resources/Shaders/SpecularTriplanar",
			texture = "Resources/Game/Props/LongTable_Foreman/Grain.png",
