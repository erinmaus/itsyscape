--------------------------------------------------------------------------------
-- Resources/Game/Props/ViziersRock_Sewers_TriangleMark/View.lua
--
...
local TriangleMark = Class(PropView)

function TriangleMark:load()
	PropView.load(self)
	...
	resources:queue(
		TextureResource,
		"Resources/Game/Props/ViziersRock_Sewers_TriangleMark/Texture.png",
		function(texture)
