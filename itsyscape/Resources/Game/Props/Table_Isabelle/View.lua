--------------------------------------------------------------------------------
-- Resources/Game/Props/Table_Isabelle/View.lua
--
...
Table.DESCRIPTION = {
	{
		mesh = "Resources/Game/Props/Table_Isabelle/Model.lstatic",
		group = "grain",

		material = {
			shader = "Resources/Shaders/SpecularTriplanar",
			texture = "Resources/Game/Props/Table_Isabelle/Grain.png",
