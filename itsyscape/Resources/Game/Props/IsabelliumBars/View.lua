--------------------------------------------------------------------------------
-- Resources/Game/Props/IsabelliumBars/View.lua
--
...
Bars.MATERIAL = DecorationMaterial({
	...
	texture = "Resources/Game/Props/IsabelliumBars/Metal.png",
	uniforms = {
...
Bars.MESSY_GREEBLE = {
	MESH = "Resources/Game/Props/IsabelliumBars/Model.lstatic",
	GROUP = "bars.messy"
}
