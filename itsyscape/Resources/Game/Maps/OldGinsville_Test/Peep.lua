...
function Ginsville:onLoad(filename, args, layer)
	...
	sky.dayAmbientColor = Color.fromHexString("433b5a")
	sky.dawnSkyColor = Color.fromHexString("1a1722")
	sky.dawnAmbientColor = Color.fromHexString("433b5a")
	sky.duskSkyColor = Color.fromHexString("1a1722")
	sky.duskAmbientColor = Color.fromHexString("433b5a")
	sky.nightSkyColor = Color.fromHexString("1a1722")
	sky.nightAmbientColor = Color.fromHexString("433b5a")
	sky.sunColor = Color.fromHexString("433b5a")
