--------------------------------------------------------------------------------
-- Resources/Game/Maps/Rumbridge_Castle_Floor3/Peep.lua
--
...
function Castle:new(resource, name, ...)
	Map.new(self, resource, name or 'Rumbridge_Castle_Floor3', ...)
...
function Castle:onLoad(filename, args, layer)
	...
	Utility.Map.spawnMap(self, "Rumbridge_Castle_Floor2", Vector.ZERO, { isLayer = true })

	local offset = self:getBehavior(MapOffsetBehavior)
	offset.offset = Vector(0, 16.3, 0)
end
