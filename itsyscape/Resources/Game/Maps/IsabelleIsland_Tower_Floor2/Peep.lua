--------------------------------------------------------------------------------
-- Resources/Game/Maps/IsabelleIsland_Tower_Floor2/Peep.lua
--
...
function Tower:new(resource, name, ...)
	Map.new(self, resource, name or 'IsabelleIsland_Tower_Floor2', ...)
...
function Tower:onLoad(filename, args, layer)
	...
	Utility.Map.spawnMap(self, "IsabelleIsland_Tower", Vector.ZERO, { isLayer = true })
