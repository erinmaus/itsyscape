...
message {
	...
	"Sometimes we live them."
}

if _TARGET:getState():has("KeyItem", "CalmBeforeTheStorm_KursedByCthulhu") then
	message {
		"Seems to be worse for you, though, right?",
		"You didn't just drown!",
		"No, there's more than that..."
	}

	message "A horror, a kurse, wrought into your very soul!"

	message {
		"Maybe you should've listened to %person{Hans}",
		"when he told you to enter the portal."
	}

	message {
		"That's right, %person{${PLAYER_NAME}}.",
		"I know everything."
	}
...
message {
	"You're special. You can't die. That's unique.",
	"Only few can claim such a gift.",
