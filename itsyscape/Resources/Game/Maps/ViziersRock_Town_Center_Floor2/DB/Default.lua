...
M._MAP = ItsyScape.Resource.Map "ViziersRock_Town_Center_Floor2"
...
M["Chest_Default8"] = ItsyScape.Resource.MapObject.Unique()
do
	ItsyScape.Meta.MapObjectLocation {
		PositionX = 25.000000,
		PositionY = 0.000000,
		...
		Name = "Chest_Default8",
		Map = M._MAP,
		Resource = M["Chest_Default8"]
	}

	ItsyScape.Meta.PropMapObject {
		Prop = ItsyScape.Resource.Prop "Chest_Default",
		MapObject = M["Chest_Default8"]
	}
end
...
M["Chest_Default7"] = ItsyScape.Resource.MapObject.Unique()
do
	ItsyScape.Meta.MapObjectLocation {
		PositionX = 23.000000,
		PositionY = 0.000000,
		...
		Name = "Chest_Default7",
		Map = M._MAP,
		Resource = M["Chest_Default7"]
	}

	ItsyScape.Meta.PropMapObject {
		Prop = ItsyScape.Resource.Prop "Chest_Default",
		MapObject = M["Chest_Default7"]
	}
end

M["Chest_Default4"] = ItsyScape.Resource.MapObject.Unique()
do
	ItsyScape.Meta.MapObjectLocation {
		PositionX = 13.000000,
		PositionY = 0.000000,
		...
		Name = "Chest_Default4",
		Map = M._MAP,
		Resource = M["Chest_Default4"]
	}

	ItsyScape.Meta.PropMapObject {
		Prop = ItsyScape.Resource.Prop "Chest_Default",
		MapObject = M["Chest_Default4"]
	}
end
