--------------------------------------------------------------------------------
-- Resources/Game/Maps/Trailer_ViziersRockSewers/Peep.lua
--
...
function Sewers:new(resource, name, ...)
	Map.new(self, resource, name or 'Trailer_ViziersRockSewers', ...)
end
...
function Sewers:moveBoss(boss)
	...
	local bossI, bossJ = Utility.Peep.getTile(boss)
	local bossPosition = bossMap:getTileCenter(bossI, bossJ)

	Utility.Peep.setPosition(boss, Vector(bossPosition.x,  fishingSpotPosition.y + -boss.DIVE_OFFSET_Y, bossPosition.z))
