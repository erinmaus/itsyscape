...
function Renderer:_drawOutlines(width, height)
	...
	print(">>> self.initDistancePostProcessShader")
	...
	print(">>> self.distancePostProcessShader")
	...
	print(">>> self.composePostProcessShader")
	love.graphics.setColor(1, 1, 1, 1)
	local thickness = math.clamp((20 - self.camera:getDistance()), 4, 15)
	print(">>> thickness", thickness)
	self.composePostProcessShader:send("scape_OutlineThickness", thickness)
	love.graphics.draw(currentBuffer)
	...
	print(">>> self.jitterPostProcessShader")
	--love.graphics.draw(self.outlinePass:getOBuffer():getCanvas(1))
