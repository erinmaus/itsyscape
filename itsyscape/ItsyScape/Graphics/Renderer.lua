...
function Renderer:_drawOutlines(width, height, uniforms)
	...
	self.outlinePostProcessShader:send("scape_OutlineColorTexture", self.finalDeferredPass:getGBuffer():getCanvas(5))
	...
	self.sobelPostProcessShader:send("scape_OutlineColorTexture", self.alphaMaskPass:getABuffer():getCanvas(2))
	...
	self.sobelPostProcessShader:send("scape_OutlineColorTexture", self.particleOutlinePass:getOBuffer():getCanvas(2))
	...
	self.composePostProcessShader:send("scape_OutlineColorTexture",  self.finalDeferredPass:getGBuffer():getCanvas(5))
	...
	self.composePostProcessShader:send("scape_MinOutlineThickness", uniforms["scape_MinOutlineThickness"] or 4)
