...
function Renderer:_drawOutlines(width, height)
	...
	love.graphics.setColor(1, 1, 1, 1)
	local thickness = math.clamp((20 - self.camera:getDistance()), 5, 15)
	...
	self.composePostProcessShader:send("scape_MinOutlineThickness", 5)
	self.composePostProcessShader:send("scape_MaxOutlineThickness", 15)
	self.composePostProcessShader:send("scape_NearOutlineDistance", 2)
	self.composePostProcessShader:send("scape_FarOutlineDistance", 20)
	love.graphics.draw(currentBuffer)
