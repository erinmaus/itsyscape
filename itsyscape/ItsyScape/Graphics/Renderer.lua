...
function Renderer:_drawOutlines(width, height)
	...
	self.outlinePostProcessShader:send("scape_PlanarComparisonFactor", 1)
	self.outlinePostProcessShader:send("scape_MinDepth", 0.05)
	self.outlinePostProcessShader:send("scape_MaxDepth", 0.2)
