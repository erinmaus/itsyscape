...
function Renderer:_drawOutlines(width, height)
	...
	self.composePostProcessShader:send("scape_MinOutlineThickness", 0.5)
	self.composePostProcessShader:send("scape_MaxOutlineThickness", 10)
	self.composePostProcessShader:send("scape_NearOutlineDistance", 5)
	self.composePostProcessShader:send("scape_FarOutlineDistance", 30)
	self.composePostProcessShader:send("scape_MaxOutlineDepthAlpha", 0.5)
	self.composePostProcessShader:send("scape_MinOutlineDepthAlpha", 1.0)
	self.composePostProcessShader:send("scape_OutlineFadeDepth", 10)
