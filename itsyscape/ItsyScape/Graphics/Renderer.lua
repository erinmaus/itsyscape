...
function Renderer:_drawOutlines(width, height, uniforms)
	...
	self.outlinePostProcessShader:send("scape_OutlineColorTexture", self.alphaMaskPass:getABuffer():getCanvas(2))
	...
	self.outlinePostProcessShader:send("scape_OutlineColorTexture", self.particleOutlinePass:getOBuffer():getCanvas(2))
