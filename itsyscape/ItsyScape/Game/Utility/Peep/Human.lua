...
Human.ANIMATIONS = {
	...
	{ "animation-idle-musket", "Human_IdleBlunderbuss_1" },
	...
	{ "animation-action-eat-left", "Human_ActionEat_Left_1" },
	{ "animation-action-eat-right", "Human_ActionEat_Right_1" },
	...
	{ "animation-defend-right", "Human_Defend_Right_1" },
	{ "animation-defend-left", "Human_Defend_Left_1" },
