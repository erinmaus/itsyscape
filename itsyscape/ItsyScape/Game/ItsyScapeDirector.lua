...
function ItsyScapeDirector:new(game, gameDB)
	...
	self:addCortex(require "ItsyScape.Peep.Cortexes.MoveToPositionCortex")
	self:addCortex(require "ItsyScape.Peep.Cortexes.FlyingCortex")
	...
	self:addCortex(require "ItsyScape.Peep.Cortexes.DodgeCortex")
