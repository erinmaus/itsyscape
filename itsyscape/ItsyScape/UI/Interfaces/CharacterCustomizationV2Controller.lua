...
local SKINS = {
	hair = {
		...
		{ name = "NB", filename = "Resources/Game/Skins/PlayerKit1/Hair/Enby.lua" },
		{ name = "Fade", filename = "Resources/Game/Skins/PlayerKit1/Hair/Fade.lua" },
		{ name = "Afro", filename = "Resources/Game/Skins/PlayerKit1/Hair/Afro.lua" },
		{ name = "Emo", filename = "Resources/Game/Skins/PlayerKit1/Hair/Emo.lua" },
		{ name = "Messy (purple)", filename = "Resources/Game/Skins/PlayerKit1/Hair/Messy.lua" },
		{ name = "Messy (black)", filename = "Resources/Game/Skins/PlayerKit1/Hair/Messy_Black.lua" },
		{ name = "Pixie", filename = "Resources/Game/Skins/PlayerKit1/Hair/Pixie.lua" },
		{ name = "Long curve", filename = "Resources/Game/Skins/PlayerKit1/Hair/LongCurve.lua" },
		{ name = "Red bow", filename = "Resources/Game/Skins/PlayerKit1/Hair/RedBow.lua" },
		{ name = "Zombi punk", filename = "Resources/Game/Skins/PlayerKit1/Hair/ZombiPunk.lua" },
		{ name = "Forward swirl", filename = "Resources/Game/Skins/PlayerKit1/Hair/ForwardSwirl.lua" },
		{ name = "Forward spike", filename = "Resources/Game/Skins/PlayerKit1/Hair/ForwardSpike.lua" },
		{ name = "Slick pokey", filename = "Resources/Game/Skins/PlayerKit1/Hair/SlickPokey.lua" },
		{ name = "Black braid", filename = "Resources/Game/Skins/PlayerKit1/Hair/BlackBraid.lua" },
		{ name = "Dark red braid", filename = "Resources/Game/Skins/PlayerKit1/Hair/DarkRedBraid.lua" },
		{ name = "Curly", filename = "Resources/Game/Skins/PlayerKit1/Hair/Curly.lua" },
		{ name = "Grrl punk", filename = "Resources/Game/Skins/PlayerKit1/Hair/GrrlPunk.lua" },
	...
	eyes = {
		slot = Equipment.PLAYER_SLOT_HEAD,
		priority = math.huge,
		{ name = "Runic", filename = "Resources/Game/Skins/PlayerKit1/Eyes/Eyes.lua" },
		{ name = "Grey", filename = "Resources/Game/Skins/PlayerKit1/Eyes/Eyes_Grey.lua" },
		{ name = "Red", filename = "Resources/Game/Skins/PlayerKit1/Eyes/Eyes_Red.lua" },
		{ name = "Dark red", filename = "Resources/Game/Skins/PlayerKit1/Eyes/Eyes_DarkRed.lua" },
		{ name = "Green", filename = "Resources/Game/Skins/PlayerKit1/Eyes/Eyes_Green.lua" },
		{ name = "Brown", filename = "Resources/Game/Skins/PlayerKit1/Eyes/Eyes_Brown.lua" },
		{ name = "Grrl punk", filename = "Resources/Game/Skins/PlayerKit1/Eyes/Eyes_GrrlPunk.lua" },
		{ name = "Undead", filename = "Resources/Game/Skins/PlayerKit1/Eyes/WhiteEyes_Green.lua" },
		{ name = "Undead (Pink)", filename = "Resources/Game/Skins/PlayerKit1/Eyes/WhiteEyes_Pink.lua" },
		{ name = "Undead (Gold)", filename = "Resources/Game/Skins/PlayerKit1/Eyes/WhiteEyes_Gold.lua" },
		{ name = "Undead (Black)", filename = "Resources/Game/Skins/PlayerKit1/Eyes/WhiteEyes_Black.lua" },
		{ name = "Robot eyes (neutral)", filename = "Resources/Game/Skins/PlayerKit1/Eyes/RobotEyes_Black.lua" },
		{ name = "Robot eyes (happy)", filename = "Resources/Game/Skins/PlayerKit1/Eyes/RobotEyes_Green.lua" },
		{ name = "Robot eyes (angry)", filename = "Resources/Game/Skins/PlayerKit1/Eyes/RobotEyes_Red.lua" },
