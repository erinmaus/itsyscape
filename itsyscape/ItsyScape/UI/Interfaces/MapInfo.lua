...
function MapInfo.Line:draw()
	...
	itsyrealm.graphics.print({ title }, 2, -(self.fontTitle:getHeight() + self.fontDescription:getHeight() + self.PADDING) + 2)
	love.graphics.setColor(1, 1, 1, a)
	itsyrealm.graphics.print({ title }, 0, -(self.fontTitle:getHeight() + self.fontDescription:getHeight() + self.PADDING))

	love.graphics.setFont(self.fontDescription)
	love.graphics.setColor(0, 0, 0, a)
	itsyrealm.graphics.print({ description }, 2, -self.fontDescription:getHeight() + 2)
	love.graphics.setColor(1, 1, 1, a)
	itsyrealm.graphics.print({ description }, 0, -self.fontDescription:getHeight())
